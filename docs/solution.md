...
| 视频录制 | 说"录制/拍视频" 或点击录制按钮 | 浏览器本地录制 | MediaRecorder API |
| 视频剪辑 | 说"剪辑/剪个vlog/highlight" | ArkClaw 终端 + TOS 存储 | ArkClaw Gateway + Volcengine TOS |
...
| 优先级 | 1. 视频剪辑 → 2. 飞书 → 3. 停止录制 → 4. 录视频 → 5. 拍照 → 6. 搜索 → 7. 闲聊 | |
| 飞书模式数 | 17 条 | 中文 + 英文 |
